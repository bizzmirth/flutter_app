...
class TEProductPayoutsPage extends StatefulWidget {
  const TEProductPayoutsPage({super.key});

  @override
  State<TEProductPayoutsPage> createState() => _TEProductPayoutsPageState();
}

class _TEProductPayoutsPageState extends State<TEProductPayoutsPage> {
