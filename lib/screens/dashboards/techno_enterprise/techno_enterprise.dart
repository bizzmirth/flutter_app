...
import 'package:bizzmirth_app/screens/dashboards/techno_enterprise/customers/customer.dart';
...
class TEDashboardPage extends StatefulWidget {
  const TEDashboardPage({super.key});

  @override
  State<TEDashboardPage> createState() => _TEDashboardPageState();
}

class _TEDashboardPageState extends State<TEDashboardPage> {
  @override
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const TEDashboardPage()),
                      );
                    },
                  ),
                  ListTile(
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const ViewPackagePage()),
                      );
                    },
                  ),
                  ExpansionTile(
                    ...
                    children: [
                      _drawerItem(context, Icons.payment, 'Product Payout',
                          const TEProductPayoutsPage(),
                          padding: true),
                      _drawerItem(context, Icons.payment,
                          'T.A. Recruitment Payout', const TEPayoutsPage(),
                          padding: true),
                    ],
                  ),
                  const Divider(),
