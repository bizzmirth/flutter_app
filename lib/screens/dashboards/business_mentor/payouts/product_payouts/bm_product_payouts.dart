...
class BMProductPayoutsPage extends StatefulWidget {
  const BMProductPayoutsPage({super.key});

  @override
  State<BMProductPayoutsPage> createState() => _BMProductPayoutsPageState();
}

class _BMProductPayoutsPageState extends State<BMProductPayoutsPage> {
