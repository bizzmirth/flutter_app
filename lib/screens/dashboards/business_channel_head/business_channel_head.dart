...
import 'package:bizzmirth_app/screens/dashboards/business_channel_head/business_mentor/business_mentor.dart';
import 'package:bizzmirth_app/screens/dashboards/business_channel_head/customer/customer.dart';
import 'package:bizzmirth_app/screens/dashboards/business_channel_head/payouts/bch_payouts/bch_payouts.dart';
import 'package:bizzmirth_app/screens/dashboards/business_channel_head/payouts/product_payouts/bch_product_payouts.dart';
...
class BCHDashboardPage extends StatefulWidget {
  const BCHDashboardPage({super.key});

  @override
  State<BCHDashboardPage> createState() => _BCHDashboardPageState();
}

class _BCHDashboardPageState extends State<BCHDashboardPage> {
  @override
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const BCHDashboardPage()),
                      );
                    },
                  ),
                  ListTile(
                  ...
                  ExpansionTile(
                    ...
                    children: [
                      _drawerItem(context, Icons.payment, 'Product Payout',
                          const BCHProductPayoutsPage(),
                          padding: true),
                      _drawerItem(context, Icons.payment, 'BCH Payouts',
                          const BCHPayoutsPage(),
                          padding: true),
                    ],
                  ),
                  ListTile(
                    leading: const Icon(Icons.people),
                    title: const Text('Business Mentor'),
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) =>
                                const ViewBusinessMentorPage()),
                      );
                    },
                  ),
                  ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const ViewTEPage1()),
                      );
                    },
                  ),
                  ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const ViewTCPage1()),
                      );
                    },
                  ),
                  ListTile(
