...
class BCHProductPayoutsPage extends StatefulWidget {
  const BCHProductPayoutsPage({super.key});

  @override
  State<BCHProductPayoutsPage> createState() => _BCHProductPayoutsPageState();
}

class _BCHProductPayoutsPageState extends State<BCHProductPayoutsPage> {
