...
class CuMembershipPayouts extends StatefulWidget {
  ...
  @override
  State<CuMembershipPayouts> createState() => _CuMembershipPayoutsState();
}
...
class _CuMembershipPayoutsState extends State<CuMembershipPayouts> {
    ...
    List<PayoutItem> getPayoutList() {
      ...
      switch (payoutType.toLowerCase()) {
        ...
        case 'previous payouts':
          return controller.previousPayoutList;

        case 'next payout':
        case 'next payouts':
          return controller.nextPayoutList;
                            ...
                            child: SizedBox(
                              ...
                              child: payoutList.isEmpty
                                  ...
                                  : PaginatedDataTable(
                                      ...
                                      source: FranchiseeTotalCuCommonDataSource(
  ...
  Widget _buildPayoutItem(PayoutItem payout, bool isLast) {
    return Container(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  totalPayoutCard(controller.totalPayoutAmount, controller),
  ...
  Widget payoutCard(String title, String date, String amount, String status,
      Color statusColor, FranchiseeCuPayoutsController controller) {
    return Container(
      padding: const EdgeInsets.all(16),
  ...
  Widget totalPayoutCard(
      String? totalPayout, FranchiseeCuPayoutsController controller) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: _boxDecoration(),
      child: Stack(
