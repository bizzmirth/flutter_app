...
class BDMProductPayoutsPage extends StatefulWidget {
  const BDMProductPayoutsPage({super.key});

  @override
  State<BDMProductPayoutsPage> createState() => _BDMProductPayoutsPageState();
}

class _BDMProductPayoutsPageState extends State<BDMProductPayoutsPage> {
