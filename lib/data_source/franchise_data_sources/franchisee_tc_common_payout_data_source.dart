...
class FranchiseeTcCommonPayoutDataSource extends DataTableSource {
  List<CuPayoutItem> payoutList;
  FranchiseeTcCommonPayoutDataSource({required this.payoutList});
  @override
