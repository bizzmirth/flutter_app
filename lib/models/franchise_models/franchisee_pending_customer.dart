...
class FranchiseePendingCustomer {
  String? id;
  dynamic caCustomerId;
  String? firstname;
  String? lastname;
  dynamic nomineeName;
  ...
  FranchiseePendingCustomer({this.id, this.caCustomerId, this.firstname, this.lastname, this.nomineeName, this.nomineeRelation, this.email, this.countryCode, this.contactNo, this.dateOfBirth, this.age, this.gender, this.country, this.state, this.city, this.pincode, this.address, this.note, this.profilePic, this.panCard, this.aadharCard, this.votingCard, this.passbook, this.paymentProof, this.termsCondition, this.paymentMode, this.chequeNo, this.chequeDate, this.bankName, this.transactionNo, this.userType, this.registrant, this.referenceNo, this.taReferenceNo, this.taReferenceName, this.registerBy, this.paidAmount, this.customerType, this.compChek, this.addedOn, this.registerDate, this.deletedDate, this.status});

  FranchiseePendingCustomer.fromJson(Map<String, dynamic> json) {
    id = json['id'];
